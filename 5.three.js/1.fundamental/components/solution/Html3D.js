    ...
    function main() {
...

      {
        ...
        const indexTexture = loader.load(
          "https://threejsfundamentals.org/threejs/resources/data/world/country-index-texture.png",
          render
        );
        ...
        const texture = loader.load(
          "https://threejsfundamentals.org/threejs/resources/data/world/country-outlines-4k.png",
          render
        );
      ...
      async function loadCountryData() {
        countryInfos = await loadJSON(
          "https://threejsfundamentals.org/threejs/resources/data/world/country-info.json"
        );
